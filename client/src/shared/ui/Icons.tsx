export const FileIcon = ({ width, height }: { width: string, height: string }) => {
  return (
    <svg
...
export const TrashBinIcon = ({ width, height }: { width: string, height: string}) => {
  return (
    <svg
      className={"fill-inherit"}
      xmlns="http://www.w3.org/2000/svg"
